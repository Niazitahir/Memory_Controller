...
HD_PWD='C:/Users/khanm/AppData/Roaming/Xilinx/Vivado/proj/DDR_GOLDEN/DDR_GOLDEN.runs/design_1_mem_controller_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_mem_controller_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_mem_controller_0_1.tcl
