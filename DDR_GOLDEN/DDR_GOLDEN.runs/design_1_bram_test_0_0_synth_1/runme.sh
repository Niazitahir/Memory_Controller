...
HD_PWD='C:/Users/khanm/AppData/Roaming/Xilinx/Vivado/proj/DDR_GOLDEN/DDR_GOLDEN.runs/design_1_bram_test_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_bram_test_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_bram_test_0_0.tcl
